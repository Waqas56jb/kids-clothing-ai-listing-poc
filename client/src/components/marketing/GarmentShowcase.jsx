  ...
  return (
    <section id="showcase" className="relative overflow-hidden bg-ink py-24 text-sand sm:py-32">
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        >
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-gold">Presentation</p>
          ...
          <p className="mt-4 text-base leading-relaxed text-white/65">
            Clean crops, matched across photos, priced with a range — tilt the cards to feel the depth.
          </p>
        </motion.div>
                ...
                <div className="flex h-full flex-col overflow-hidden rounded-[1.5rem] bg-white text-ink shadow-elevated">
                  ...
                  <div className="flex flex-1 flex-col gap-3 p-5 [transform:translateZ(36px)]">
                    ...
                    <div className="mt-auto flex items-end justify-between border-t border-slate-100 pt-3">
                      <div>
                        <p className="text-[10px] uppercase tracking-wide text-slate-400">Range</p>
                        <p className="text-sm font-semibold text-slate-700">{item.range} SEK</p>
                      </div>
                      <div className="text-right">
                        <p className="text-[10px] uppercase tracking-wide text-slate-400">Suggested</p>
                        <p className="font-display text-2xl font-semibold text-moss">{item.recommended}</p>
                      </div>
                    </div>
                  </div>
                </div>
